...
tp方块是一类不可任意写入的命令方块。在方块合成成型的时候，内部的传送距离的能量需求就随之确定了。我们组的工作就是在增加传送距离的同时，减少相应的传说能量需求。
...
我突然庆幸，这是一块不带任何命令部件的手表。否则，这块手边可就没法正常显示时间了，还可能因此惊动那个躲着很久的Tomato间谍。
...
为了保证我和他“距离最近”，我抓住了他的手臂。因为刚才在中央广场，我设定的语句是——
...
无论如何，只要与我的身体接触，那么，目标选择器就会将实体视为“与我最近”。



然后，我把兔肉煲往身后举起，为了验证我的猜想，我们的身后有一个透明的Tomato间谍，我轻蔑地说道：
